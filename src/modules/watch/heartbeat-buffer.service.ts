...
export class HeartbeatBufferService {
  async bufferHeartbeat(params: {
    ...
    const snapshot: BufferedHeartbeatSnapshot = {
      ...
      tvdbId: params.identity.provider === 'tvdb' ? Number(params.identity.providerId) : null,
      kitsuId: params.identity.provider === 'kitsu' ? (params.identity.providerId ?? null) : null,
