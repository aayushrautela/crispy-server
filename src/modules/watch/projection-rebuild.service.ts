...
function projectionFromEvent(event: RebuildableWatchEvent): WatchMediaProjection {
  return {
    ...
    playbackProvider: event.playbackProvider === 'tmdb' || event.playbackProvider === 'tvdb' || event.playbackProvider === 'kitsu'
      ...
      : null,
    playbackProviderId: event.playbackProviderId,
    playbackParentProvider: event.playbackParentProvider === 'tmdb' || event.playbackParentProvider === 'tvdb' || event.playbackParentProvider === 'kitsu'
      ? event.playbackParentProvider
      : null,
    playbackParentProviderId: event.playbackParentProviderId,
