  ...
  const metadataCardService = {
    async buildCardViews(_client, identities, language) {
      ...
      return identities.map((identity): MetadataCardView => ({
        ...
        summary: null,
        overview: null,
        artwork: { posterUrl: 'https://img.test/poster.jpg', backdropUrl: 'https://img.test/backdrop.jpg', stillUrl: null },
        images: { posterUrl: 'https://img.test/poster.jpg', backdropUrl: 'https://img.test/backdrop.jpg', stillUrl: null, logoUrl: null },
        releaseDate: null,
        releaseYear: 2024,
        runtimeMinutes: 45,
        rating: 7.5,
