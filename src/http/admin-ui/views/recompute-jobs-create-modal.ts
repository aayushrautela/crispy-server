      ...
      <section class="panel modal-card" role="dialog" aria-modal="true" aria-labelledby="recompute-create-title">
        <div class="panel-head">
          <div>
            ...
            <p class="panel-note">Queue recommendation recompute work for selected profiles, selected accounts, or every eligible user.</p>
          </div>
        ...
        <div class="panel-body section-stack">
          ...
          <form id="recompute-create-form" class="section-stack">
            ...
            <label id="recompute-create-targets-row">Targets
              <textarea id="recompute-create-targets" name="targets" rows="5" placeholder="One profile or account id per line"></textarea>
            </label>
            <label>Reason
